import pandas as pd
from src.datasetup.models.info.classid_schoolid import SchoolClass, SchidSchoolid
from src.datasetup.models.info.classid_schoolid.model import ClassIdSchoolId
