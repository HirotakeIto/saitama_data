import pandas as pd
import numpy as np
from src.lib.read_config import ReadConfig2015, ReadConfig2017, ReadConfig2016, ReadConfig2018
from src.datasetup.models.master.gakuryoku.model import Gakuryoku
...
def seed():
    c = ReadConfig2015(path='src/setting.ini')
    c.get_setting()
